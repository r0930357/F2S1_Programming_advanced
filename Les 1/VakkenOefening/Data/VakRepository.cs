...
namespace VakkenOefening.Data
{
    public class VakRepository
    {
        ...
        {
            new Vak() { Id = 1, Naam = "Vak1", Afbeelding = "vak1.jpg", RowNumberGrid = 0, ColumnNumberGrid = 0 },
            new Vak() { Id = 2, Naam = "Vak2", Afbeelding = "vak2.jpeg", RowNumberGrid = 0, ColumnNumberGrid = 1 },
            new Vak() { Id = 3, Naam = "Vak3", Afbeelding = "vak3.jpg", RowNumberGrid = 1, ColumnNumberGrid = 0 },
            new Vak() { Id = 4, Naam = "Vak4", Afbeelding = "vak4.jpeg", RowNumberGrid = 1, ColumnNumberGrid = 1 },
            new Vak() { Id = 5, Naam = "Vak5", Afbeelding = "vak5.jpg", RowNumberGrid = 2, ColumnNumberGrid = 0 }
        };

        // Methode om de vakken op te vragen
